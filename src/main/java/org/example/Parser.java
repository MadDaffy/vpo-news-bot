 ...
 *
 * <p>Никакие LLM/нейросети не используются. Поиск полностью детерминирован.
 *
 * <p><b>Основная логика:</b>
 * <ul>
...
public class Parser {
     ...
     *
     * <p>Для каждого источника выполняется HTTP GET-запрос. Если статус ответа не 200,
     ...
     *
     * <p>Запрос разбивается на токены через {@link RussianAnalyzer}, для каждого токена
     ...
     *
     * <p><b>Пример:</b> запрос «сводка СВО на сегодня» после стемминга даст основы
     ...
     *
     * <p>Использует {@link RussianAnalyzer}, который приводит слова к начальной форме

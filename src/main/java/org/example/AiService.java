...
public class AiService {
     ...
     * Предлоги, союзы, частицы, междометия, местоимения игнорируются.
     * @return список фраз или null при ошибке
     */
    public List<String> expandQuery(String userQuery) {
        // Улучшенный промпт: объясняем модели, что имена собственные важны и их нужно склонять
        String prompt = String.format(
                "<|turn|>system\n" +
                        ...
                        "ВАЖНО: Обрабатывай ВСЕ знаменательные слова, включая имена собственные, названия, фамилии и аббревиатуры.\n" +
                        "<|turn|>user\n" +
                        "Из запроса \"%s\" выдели АБСОЛЮТНО ВСЕ ЗНАМЕНАТЕЛЬНЫЕ СЛОВА. " +
                        "Обрати особое внимание: если видишь имя, фамилию или название (даже с маленькой буквы), обязательно построй для них словоформы. " +
